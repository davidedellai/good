...
public class HazyCaseView extends FrameLayout {
    private static final String TAG = HazyCaseView.class.getSimpleName();
    ...
    private static final int[] PASTRIES = {
            R.drawable.hazy_logo,      // Hazy logo team
            R.drawable.hazy_rom,     // Hazy Rom
            R.drawable.dessert_kitkat,   // thx irina
    };

    private static final int[] RARE_PASTRIES = {
            R.drawable.dessert_android, // used with permission
            ...
            R.drawable.hazy_hand,           // Hazy 2014
            R.drawable.hazy_shuttle,        // Hazy 2014
            R.drawable.pupino_figo,         // Hazy 2014
            R.drawable.spiaggino,           // Hazy 2014
    };
    ...
    private static final int[] XRARE_PASTRIES = {
            ...
            R.drawable.hazy_price,           // Hazy 2014
    };
    ...
    public HazyCaseView(Context context) {
        this(context, null);
    }

    public HazyCaseView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HazyCaseView(Context context, AttributeSet attrs, int defStyle) {
...
//        return 0xFF000000 | (int) (Math.random() * (float) 0xFFFFFF); // totally random
    ...
    public static class RescalingContainer extends FrameLayout {
        ...
        public void setView(HazyCaseView v) {
            addView(v);
            mView = v;
        }
